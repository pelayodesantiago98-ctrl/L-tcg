...
/*
 * La precarga necesita una reserva propia y más alta. No la está esperando
 * nadie, va a durar semanas y es la única que puede vaciar la cuota entera
 * sola, así que lo que no puede es dejar sin margen a quien esté navegando
 * ahora mismo. `reserva` se compara contra los dos contadores, o sea que esto
 * aparta 15 peticiones de la hora y otras 15 del día para la navegación. Las
 * imágenes que pide el navegador siguen yendo con reserva 0: son justo las
 * que alguien está esperando en pantalla.
 */
const RESERVA_PRECARGA = 15;
...
module.exports = {
  ...
  cuotaActual, SinCuota, RESERVA_HORA, RESERVA_PRECARGA, BASE,
};
